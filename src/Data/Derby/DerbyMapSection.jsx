...
const areaCoordinates = {
  "Derby City Centre": { lat: 52.9225, lng: -1.4746 },
  Allestree: { lat: 52.939, lng: -1.506 },
  Littleover: { lat: 52.906, lng: -1.511 },
  Chaddesden: { lat: 52.922, lng: -1.433 },
  Spondon: { lat: 52.914, lng: -1.409 },
  Mickleover: { lat: 52.906, lng: -1.547 },
  Alvaston: { lat: 52.899, lng: -1.438 },
  Chellaston: { lat: 52.871, lng: -1.433 },
  Oakwood: { lat: 52.927, lng: -1.451 },
  Borrowash: { lat: 52.908, lng: -1.397 },
  Breadsall: { lat: 52.952, lng: -1.451 }
};
...
/* ---------------- MAIN COMPONENT ---------------- */
export default function DerbyMapSection() {
