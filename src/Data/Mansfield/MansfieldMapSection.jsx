...
const areaCoordinates = {
  "Mansfield Town Centre": { lat: 53.144, lng: -1.198 },
  "Sutton-in-Ashfield": { lat: 53.128, lng: -1.27 },
  "Kirkby-in-Ashfield": { lat: 53.112, lng: -1.26 },
  "Forest Town": { lat: 53.134, lng: -1.193 },
  Clipstone: { lat: 53.138, lng: -1.237 },
  Rainworth: { lat: 53.116, lng: -1.202 },
  Warsop: { lat: 53.155, lng: -1.179 },
  Pleasley: { lat: 53.14, lng: -1.227 },
  Shirebrook: { lat: 53.173, lng: -1.183 }
};
...
/* ---------------- MAIN COMPONENT ---------------- */
export default function MansfieldMapSection() {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
            Mansfield Service Coverage Map
          </h2>
        </div>
