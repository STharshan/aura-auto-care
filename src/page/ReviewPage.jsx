...
export default function ReviewPage() {
    ...
    return (
        // Changed main background to Black
        <div className="min-h-screen bg-[#000000] flex items-center justify-center p-4 sm:p-6 md:p-8">
            <div className="w-full mt-20 max-w-2xl pt-10">
                {/* Changed Card background to Dark Grey (#111111) */}
                <div className="bg-[#111111]  rounded-3xl shadow-2xl shadow-[#e80202]/10 overflow-hidden border border-[#222]">
                    ...
                    <div className="px-6 sm:px-8 md:px-12 py-8 sm:py-10 md:py-12">
                        ...
                        <div className="mb-8 text-center">
                            ...
                            <p className="text-gray-400 mb-6 text-sm sm:text-base font-medium">How would you rate our service?</p>
                            <div className="flex justify-center items-center gap-2 sm:gap-3 md:gap-4">
                                {[1, 2, 3, 4, 5].map((star) => (
                                    ...
                                    >
                                        <svg
                                            className={`w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 transition-all duration-200 ${star <= (hoveredRating || rating) ? 'text-[#e80202] fill-current drop-shadow-lg' : 'text-gray-700 fill-current'}`}
                                            viewBox="0 0 20 20"
                                        >
                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                        </svg>
                        ...
                        {/* Review Box - Form Background changed to Darker shade */}
                        {showReviewBox && !submitted && (
                            <div className="transition-all duration-500 ease-out transform translate-y-0 opacity-100">
                                <div className="bg-[#000000]/40 rounded-2xl p-6 sm:p-8 border-2 border-[#e80202]/20 shadow-lg">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        {/* Input fields updated to match Dark Contact Section style */}
                                        <input type="text" value={name} onChange={(e) => setName(e.target.value)} required placeholder="Your Name" className="w-full px-4 py-3 text-white bg-[#1a1a1a] rounded-xl border-2 border-[#333] focus:border-[#e80202] focus:ring-4 focus:ring-[#e80202]/20 outline-none" />
                                        <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="Your Email" className="w-full px-4 py-3 rounded-xl text-white bg-[#1a1a1a] border-2 border-[#333] focus:border-[#e80202] focus:ring-4 focus:ring-[#e80202]/20 outline-none" />
                                        <input type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="Phone Number (Optional)" className="w-full px-4 py-3 rounded-xl bg-[#1a1a1a] border-2 text-white border-[#333] focus:border-[#e80202] focus:ring-4 focus:ring-[#e80202]/20 outline-none" />
                                        <textarea value={reviewText} onChange={(e) => setReviewText(e.target.value)} required rows={5} placeholder="Please share your experience..." className="w-full px-4 py-3 rounded-xl border-2 text-white bg-[#1a1a1a] border-[#333] focus:border-[#e80202] focus:ring-4 focus:ring-[#e80202]/20 outline-none resize-none" />
                        ...
                        {submitted && (
                            <div className="transition-opacity duration-500 opacity-100 scale-100">
                                <div className="bg-[#e80202]/10 border-2 border-[#e80202]/30 rounded-2xl p-6 sm:p-8 text-center">
                                    ...
                                    <p className="text-gray-300 text-base sm:text-lg">Your feedback has been sent to our team.</p>
                                </div>
                            </div>
                        )}
                    </div>
