    ...
    <section className="relative min-h-screen flex items-center justify-center text-white px-6 py-20 overflow-hidden bg-black">
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 relative z-10">
        ...
        <div className="flex flex-col justify-center space-y-6">
          <h1 className="text-4xl sm:text-6xl pt-10 font-bold leading-tight">
          ...
          <p className="text-gray-300 text-lg leading-relaxed max-w-xl">
            Comprehensive interior and exterior restoration for heavily neglected or used vehicles.
          </p>

          <div className="flex gap-4 pt-4">
            <div className="px-5 py-2 bg-linear-to-t from-[#e8020233] to-[#9999991a] border border-white/10 rounded-lg backdrop-blur-sm">
              <p className="text-white text-sm font-medium">Deep Restoration</p>
            </div>
        ...
        <div className="relative bg-linear-to-br from-[#1a0000] via-[#0a0a0a] to-[#001b3f] rounded-2xl p-10 border border-white/10 shadow-[0_0_80px_-20px_rgba(255,0,0,0.5)] overflow-hidden">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div>
              ...
              <h4 className="text-xl font-semibold">
                Vehicle Reconditioning & Restoration
              </h4>
            </div>
            ...
            <div>
              ...
              <h4 className="text-xl font-semibold">
                Used Car Buyers, Enthusiasts & Fleet Vehicles
              </h4>
            </div>
